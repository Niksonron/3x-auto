...
if ! command -v install_3xui >/dev/null 2>&1; then
    ...
    INSTALL_3XUI_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
    
    # Source logging utilities
    # shellcheck source=../common/logging.sh
    source "${INSTALL_3XUI_SCRIPT_DIR}/../common/logging.sh"
    
    # Source OS detection utilities
    # shellcheck source=../common/os-detection.sh
    source "${INSTALL_3XUI_SCRIPT_DIR}/../common/os-detection.sh"
    
    # Source configuration loading utilities
    # shellcheck source=../common/load-config.sh
    source "${INSTALL_3XUI_SCRIPT_DIR}/../common/load-config.sh"
